package com.example.et.model.specs;
...
public class TransactionSpecifications {
    ...
    public static Specification<Transaction> withFilters(UUID userId, TransactionFilterParams filters) {
        return (root, query, cb) -> {
            ...
            if (filters.category() != null && !filters.category().isBlank()) {
                // Adjust "name" based on what field SystemCategory has (e.g., root.get("transactionCategory").get("name"))
